    ...
    return Scaffold(
      ...
      Column(children: [
        const Padding(
              ...
              child:Text('Редактирование пользователя', style: TextStyle(fontSize: 30,color: Color.fromARGB(255, 92, 92, 92)),),
            ),
        ...
        Column(
          ...
          children: <Widget>[
            ...
            children: const [
              ...
              Padding(
                padding: EdgeInsets.only(right: 10, bottom: 15),
                child: Text('the.email@address.com', style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 128, 127, 127)))
              ),
            ]
            ),
            Row( 
      ...
      Column(
          ...
          children: <Widget>[
            const Padding(
              ...
              child:Text('Смена пароля', style: TextStyle(fontSize: 30,color: Color.fromARGB(255, 92, 92, 92)),),
            ),
            const Padding(
              padding: EdgeInsets.only(bottom: 20),
              child: SizedBox(width: 350, child:Text('Оставьте эти поля незаполненными, если вы не хотите изменять пароль.', style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 131, 128, 128)), textAlign: TextAlign.center)
              )
            ),
            Row( 
            mainAxisAlignment: MainAxisAlignment.center,
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(bottom: 15, right: 70),
                child: SizedBox(
                  width: 200,
                  height: 30,
                  child: TextFormField(
