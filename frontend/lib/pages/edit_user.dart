                  ...
                  children: [
                    Row( 
                      ...
                      children: const [
                        ...
                        Text('the.email@address.com', style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 128, 127, 127)))
                      ]
                    ),
                    Row( 
                      mainAxisAlignment: MainAxisAlignment.end,
            ...
            child: Align(
              ...
              child: Container(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    Text('Смена пароля', style: TextStyle(fontSize: 30,color: Color.fromARGB(255, 92, 92, 92)),textAlign: TextAlign.center),
                    SizedBox(
                      width: 350, 
                      child:Text('Оставьте эти поля незаполненными, если вы не хотите изменять пароль.', style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 131, 128, 128)), textAlign: TextAlign.center)
                    ),
                    Row( 
                      mainAxisAlignment: MainAxisAlignment.end,
                      children: [
